    ...
    ui.collapsing("Connector types", |ui| {
        egui::Grid::new("connector_types")
            ...
            .show(ui, |ui| {
                ...
                ui.add(
                    egui::Label::new(
                        "A curve within a single hexagon, connecting two of its edge points.",
                    )
                    .wrap(),
                );
                ui.end_row();
                ...
                ui.strong("Outside");
                ui.add(
                    egui::Label::new("A passage connecting two non-adjacent outer edge points.")
                        .wrap(),
                );
                ui.end_row();
                ui.strong("DeadEnd");
                ui.add(
                    egui::Label::new(
                        "An outer edge point with no continuation — players stop or die here.",
                    )
                    .wrap(),
                );
                ui.end_row();
    ...
    ui.collapsing("Winning conditions", |ui| {
        egui::Grid::new("winning_conditions")
            ...
            .show(ui, |ui| {
                ...
                ui.add(
                    egui::Label::new(
                        "The player who travelled the greatest total path weight wins.",
                    )
                    .wrap(),
                );
                ui.end_row();
                ...
                ui.add(
                    egui::Label::new("The player with the greatest single-turn speed wins.").wrap(),
                );
                ui.end_row();
            });
    });
    ...
    ui.collapsing("Controls reference", |ui| {
        egui::Grid::new("controls_ref")
            ...
            .show(ui, |ui| {
                ...
                ui.strong("Restart");
                ui.add(
                    egui::Label::new("Replay the current game from the start with the same seed.")
                        .wrap(),
                );
                ui.end_row();
                ui.strong("New game");
                ui.add(
                    egui::Label::new(
                        "Start a new game with the same options but a new random seed.",
                    )
                    .wrap(),
                );
                ui.end_row();
